...
def paso2_ejecutar_tarea_mision(ruta_repo, nombre_rama_mision, api_provider, modo_automatico):
    ...
    metadatos_mision, lista_tareas_mision, _ = manejadorMision.parsear_mision_orion(contenido_mision_actual_md)
    ...
    tarea_actual_info, _ = manejadorMision.obtener_proxima_tarea_pendiente(lista_tareas_mision)
    ...
    contenido_mision_post_tarea = manejadorMision.marcar_tarea_como_completada(contenido_mision_actual_md, tarea_id, "COMPLETADA")
    if not contenido_mision_post_tarea: return "error_critico_actualizando_mision", contenido_mision_actual_md
...
def ejecutarFaseDelAgente(api_provider: str, modo_automatico: bool):
                       ...
                       contenido_mision_generado_dict_todo.get("contenido_markdown_mision"):
                        ...
                        if not manejadorGit.crear_y_cambiar_a_rama(settings.RUTACLON, nombre_clave_mision_todo, rama_base_todo):
                            ...
                            try:
                                ...
                                _, tareas_gen_todo, hay_pendientes_gen_todo = manejadorMision.parsear_mision_orion(contenido_markdown_mision_todo)
    ...
    if res_paso1_1 == "generar_mision":
        ...
        if res_paso1_2 == "mision_generada_ok" and nombre_clave_generado:
            ...
            _, tareas_gen, hay_pendientes_gen = manejadorMision.parsear_mision_orion(contenido_mision_generada_md)
